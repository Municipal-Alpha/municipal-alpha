...
Sortorder: 31
Summary: Pre-earnings municipal signals. Vendor payments and building permits resolved to 136 public company tickers from 3,900+ municipalities. Updated daily.
...
<p>When Grainger ships to Geneva, Illinois, it shows up in their check register weeks before it shows up in quarterly earnings. I built a system that reads municipal payment records daily across 3,900+ municipalities and resolves vendor names to 136 public company tickers. You see the transaction before it becomes an earnings surprise.</p>
</div>
