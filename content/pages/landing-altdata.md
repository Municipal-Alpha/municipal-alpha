...
Sortorder: 31
Summary: Pre-earnings municipal signals. Vendor payments and building permits resolved to 100+ public company tickers from 4,700+ municipalities. Updated daily.
...
<p>When Grainger ships to Geneva, Illinois, it shows up in their check register weeks before it shows up in quarterly earnings. I built a system that reads municipal payment records daily across 4,700+ municipalities and resolves vendor names to 100+ public company tickers. You see the transaction before it becomes an earnings surprise.</p>
</div>
...
<div class="lp-metric">
<span class="lp-metric-value">319K</span>
...
<span class="lp-metric-label">Updates</span>
</div>
</div>

<div class="lp-section">
<h3>Two signal layers</h3>
<p><strong>Check registers and AP data.</strong> Direct vendor payments from municipal governments, entity-resolved to public tickers with amounts, dates, and categories. If a town is paying a company, that's revenue. Bottom-up, from the actual transaction.</p>
<p><strong>Building permits.</strong> 43,000+ structured permit records showing which contractors are winning work and where construction is accelerating. Permits lead earnings by 3-6 months. Combined with payment data, you see both current revenue and the pipeline.</p>
</div>

<div class="lp-buyers">
<div class="lp-buyer">
<strong>Quantitative funds</strong>
<span>Non-consensus revenue signals from primary public records, structured for systematic strategies.</span>
</div>
<div class="lp-buyer">
<strong>Fundamental analysts</strong>
<span>Primary-source data on government contractor exposure at the transaction level.</span>
</div>
<div class="lp-buyer">
<strong>Alt data platforms</strong>
<span>A new municipal dataset for distribution to hedge fund and asset manager clients.</span>
</div>
<div class="lp-buyer">
<strong>Credit analysts</strong>
<span>Municipal fiscal health indicators derived from spending patterns and payment velocity.</span>
</div>
</div>

<div class="lp-sample">
<div>
<h4>Sample signals</h4>
<p>50 redacted entity-resolved signals showing the data structure: municipality, vendor, ticker, priority, and date.</p>
</div>
<a href="/sample-data/signals-sample.csv">Download CSV &rarr;</a>
</div>

<div class="lp-bottom-cta">
<h3>See what your tickers look like in municipal data</h3>
<p>Tell me which tickers or sectors you cover and I'll show you what I can see before it hits your current sources.</p>
<a class="cta-button" href="https://calendar.app.google/HkZk29hxj7Cdtvuc9">Book a data review</a>
<span class="lp-or">or</span>
<a class="lp-email" href="mailto:matt@municipalalpha.com?subject=Alt%20data%20inquiry%20%28via%20landing%20page%29">matt@municipalalpha.com</a>
