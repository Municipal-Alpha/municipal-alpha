...
Summary: Entity resolution across 4,200+ municipalities reveals which public companies have the deepest municipal government footprint.

*Analysis based on entity resolution across 4,200+ municipalities.*
...
We are. Our pipeline resolves vendor names to public company tickers across 4,200+ municipalities. The result is a dataset that shows which companies have the deepest municipal government footprint in America, sourced from the actual payment records.
...
And this is from 4,200+ municipalities. The United States has 19,500.
...
One check register from one town is a curiosity. Entity-resolved vendor payment data across 4,200+ municipalities is an alternative dataset that tracks public company government revenue from the source documents, in near-real-time, before it shows up in quarterly earnings.
