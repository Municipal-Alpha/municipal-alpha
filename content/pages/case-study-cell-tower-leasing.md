...
The structure inventory is 161,492 FCC-registered towers, joined to location, owner, and height. Coverage is national; the largest concentrations are Texas (17,401), California (9,231), Florida (7,800), Ohio (7,171), Georgia (6,512), and Illinois (6,491). Municipal decisions come from agendas and minutes we monitor across more than 4,300+ US municipalities, classified for wireless and telecommunications activity; the wireless-decision set referenced here spans 1,105 municipalities across all 50 states. New-construction filings come from the FAA Obstruction Evaluation / Airport Airspace Analysis feed.
