...
The structure inventory is 161,492 FCC-registered towers, joined to location, owner, and height. Coverage is national; the largest concentrations are Texas (17,401), California (9,231), Florida (7,800), Ohio (7,171), Georgia (6,512), and Illinois (6,491). Municipal decisions come from agendas and minutes we monitor across more than 3,900+ US municipalities, classified for wireless and telecommunications activity; the wireless-decision set referenced here spans 1,105 municipalities across all 50 states. New-construction filings come from the FAA Obstruction Evaluation / Airport Airspace Analysis feed.
...
- Freeport, ME · Town Council, 2026-05-05 · [agenda](https://www.freeportmaine.com/AgendaCenter/ViewFile/Agenda/_05052026-838?html=true)
- Burlington, MA · Select Board, 2026-05-04 · [agenda](https://www.burlington.org/AgendaCenter/ViewFile/Agenda/_05042026-3254?html=true)
- Burlington, MA · Select Board, 2026-06-08 · [agenda](https://www.burlington.org/AgendaCenter/ViewFile/Agenda/_06082026-3294?html=true)
- Freeborn County, MN · Board of Commissioners, 2026-04-21 · [agenda](https://freeborncomn.api.civicclerk.com/v1/Meetings/GetMeetingFileStream(fileId=792,plainText=false))
- Milton, MA · Select Board, 2026-06-09 · [agenda](https://miltonma.gov/AgendaCenter/ViewFile/Agenda/_06092026-6751?html=true)
- Maynard, MA · Select Board, 2026-05-19 · [agenda](https://www.townofmaynard-ma.gov/AgendaCenter/ViewFile/Agenda/_05192026-2117?html=true)
- Bristol, NH · Select Board, 2026-05-21 · [agenda](https://bristolnh.gov/AgendaCenter/ViewFile/Agenda/_05212026-194?html=true)
- Goffstown, NH · Planning Board, 2026-04-23 · [agenda](https://www.goffstownnh.gov/AgendaCenter/ViewFile/Agenda/_04232026-1458?html=true)
- THE TOWERS, LLC · Wetumpka, AL · FAA OE/AAA case 2026-ASO-11065-OE

<div class="chart">
  <div class="ctitle">Chart 1 &middot; Where the towers are: FCC-registered structures by state (top 12 of 161,492 nationwide)</div>
  <div class="bar-row"><span class="lbl">TX</span><span class="track"><span class="fill" style="width:100%"></span></span><span class="val">17,401</span></div>
  <div class="bar-row"><span class="lbl">CA</span><span class="track"><span class="fill" style="width:53%"></span></span><span class="val">9,231</span></div>
  <div class="bar-row"><span class="lbl">FL</span><span class="track"><span class="fill" style="width:45%"></span></span><span class="val">7,800</span></div>
  <div class="bar-row"><span class="lbl">OH</span><span class="track"><span class="fill" style="width:41%"></span></span><span class="val">7,171</span></div>
  <div class="bar-row"><span class="lbl">GA</span><span class="track"><span class="fill" style="width:37%"></span></span><span class="val">6,512</span></div>
  <div class="bar-row"><span class="lbl">IL</span><span class="track"><span class="fill" style="width:37%"></span></span><span class="val">6,491</span></div>
  <div class="bar-row"><span class="lbl">NC</span><span class="track"><span class="fill" style="width:30%"></span></span><span class="val">5,262</span></div>
  <div class="bar-row"><span class="lbl">MO</span><span class="track"><span class="fill" style="width:30%"></span></span><span class="val">5,224</span></div>
  <div class="bar-row"><span class="lbl">OK</span><span class="track"><span class="fill" style="width:30%"></span></span><span class="val">5,223</span></div>
  <div class="bar-row"><span class="lbl">AL</span><span class="track"><span class="fill" style="width:29%"></span></span><span class="val">5,053</span></div>
  <div class="bar-row"><span class="lbl">MI</span><span class="track"><span class="fill" style="width:29%"></span></span><span class="val">4,969</span></div>
  <div class="bar-row"><span class="lbl">WI</span><span class="track"><span class="fill" style="width:27%"></span></span><span class="val">4,618</span></div>
  <div class="cnote">The inventory is national and Sunbelt-led. Municipal-decision coverage is deepest in the Northeast and still filling in.</div>
</div>

<div class="chart">
  <div class="ctitle">Chart 2 &middot; The lease is decided before the broker (Apr 21 &ndash; Jun 9, 2026)</div>
  <div class="timeline">
    <div class="tl lease"><div class="d">Apr 21</div><div class="t">Freeborn County, MN &middot; Vertical Bridge land-lease amendment <span class="tag">lease</span></div></div>
    <div class="tl"><div class="d">Apr 23</div><div class="t">Goffstown, NH &middot; parcel owner named under existing tower <span class="tag">ownership</span></div></div>
    <div class="tl lease"><div class="d">May 4</div><div class="t">Burlington, MA &middot; Cell Tower Lease, Blanchard Road <span class="tag">lease</span></div></div>
    <div class="tl lease"><div class="d">May 5</div><div class="t">Freeport, ME &middot; AT&amp;T structure lease, 55 Quarry Lane <span class="tag">lease</span></div></div>
    <div class="tl"><div class="d">May 19</div><div class="t">Maynard, MA &middot; cable license expiration notice <span class="tag">renewal</span></div></div>
    <div class="tl"><div class="d">May 21</div><div class="t">Bristol, NH &middot; Breezeline franchise agreement <span class="tag">renewal</span></div></div>
    <div class="tl"><div class="d">Jun 8</div><div class="t">Burlington, MA &middot; telecommunications license renewal <span class="tag">renewal</span></div></div>
    <div class="tl"><div class="d">Jun 9</div><div class="t">Milton, MA &middot; AT&amp;T small-wireless siting, 5 addresses <span class="tag">small-cell</span></div></div>
    <div class="tl-end"><div class="t">&rarr; broker / RFP / public reporting (later)</div></div>
  </div>
</div>
