...
- **1,234,000+** documents ingested and classified
- **45,000+** building permits structured
- **100+** public company tickers resolved from municipal vendor names
- **455,000+** classified signals
...
Small and mid-sized municipalities issue the same permits as large cities, just on worse websites with less standardization. That's where the coverage gap is widest. We monitor 4,500+ municipalities and structure the permit records they publish into entity- and ticker-resolved time series, 45,000+ records and growing.
