...
Municipal records come from agendas, minutes, packets, and budgets we monitor across 4,700+ US municipalities in all 50 states. Every dated example is taken from the document's own date, not from when we discovered it. The records:
