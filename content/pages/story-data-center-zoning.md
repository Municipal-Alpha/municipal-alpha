...
1. **The apples-to-apples market-acceleration view.** Within the cohort of jurisdictions that were already in our pipeline as of March 1, 2026, data center zoning records went from 3 in February to roughly 41 in April, with continued activity into May. That growth is on a fixed coverage set, so it reflects real change in municipal behavior rather than corpus expansion.
2. **The broader regulatory-reach view.** Adding jurisdictions newly onboarded since March 1, the same pattern is now visible in 80 distinct records across 47 jurisdictions in 24 states. Most of the new jurisdictions came online because the pattern itself drew attention to them, which is its own form of evidence, but it is not the same as saying market activity grew by the same factor.
...
## The August 2026 Update: From Committee Talk to Courtrooms and Codified Moratoria

*A note on method before the numbers.* The May analysis above counts documents the production pipeline had tagged data-center-zoning-related. This update instead comes from a full-text search of the corpus for "data center" across records dated May 15, 2026 or later, checked by hand against the underlying documents to strip out what a bare keyword pulls in that has nothing to do with zoning: cryptocurrency and equipment invoices, National Weather Service boilerplate quoting the "National Snow & Ice Data Center," and federal VA hospital IT-upgrade solicitations. The two counts are not directly additive, they are two different measurement lenses on the same phenomenon, which is exactly the caution the May analysis already raises about signal emissions versus distinct documents.

Three months on, the pattern the May figures caught as committee talk is now showing up as adopted law, and in one case, as a lawsuit.

**The moratoria that passed.** Brunswick, Maine's Town Council adopted a 180-day moratorium on data centers of 1 megawatt or larger on June 1, 2026. At an August 3 workshop, planning staff brought back a tiered draft ordinance, micro, small, average, and hyperscale categories keyed to electrical demand, that would let the 750 kW facility already operating at Brunswick Landing continue while requiring Council-level contract-zoning review for anything at or above 1 MW; staff explicitly weighed, and did not rule out, an outright prohibition pending a grid-impact study ([workshop packet](https://www.brunswickme.gov/AgendaCenter/ViewFile/Agenda/_08032026-3897?packet=true)). The Town of Lockport, New York moved on the same underlying question by a different mechanism: an 18-month local law on data-center permitting and approval, alongside a second 18-month moratorium on cluster-development subdivisions, both noticed for an August 5 public hearing and referenced in the neighboring City of Lockport's own August 12 council packet ([packet](https://lockportny.gov/wp-content/uploads/2026/08/Meeting-Packet-for-8.12.2026-1.pdf)), a reminder that "Lockport" in a filing can mean either of two separate governments that share a name. In Winnebago County, Wisconsin, the Town of Utica's board voted unanimously, 3-0 on August 10, to adopt whatever restriction the county settles on, with the chairman's own words on the record right after the vote: "it's keeping them out of our town" ([minutes](https://cdn.townweb.com/townofuticawi.gov/wp-content/uploads/2026/08/081026-Town-Board-Meeting-Minutes-DRAFT.pdf)).

**The moratorium now in court.** Scarborough, Maine shows what happens after a moratorium is adopted and a developer disagrees. Per the town's August 19 council update, a plaintiff has sued the town, challenging both the moratorium and the town's determination that the plaintiff's application was incomplete. A judge has already denied the plaintiff's request to keep the application processing during the suit, and denied the town's motion to dismiss; the case is in discovery, with briefs still to come ([council update](https://scarboroughmaine.community.diligentoneplatform.com/document/14547)). It is the next stage the May analysis's own thesis predicts: a new contested land use moves from ordinance language to litigation once real money sits behind an application the ordinance blocks.

**Still in the workshop stage.** Bellefonte, Delaware's Ordinance Ad Hoc Committee is drafting local language after three pieces of state legislation on data-center moratoria moved (July 14 committee notes); Shelbyville, Kentucky's council reached consensus on July 16 to recommend a moratorium on future data centers; Douglas County, Wisconsin's board raised moratorium concerns over a rezoning request on July 21; Freetown, Massachusetts is still working out, as of July 7, whether a data-center bylaw needs a Planning Board or Town Meeting path.

**The wider count.** A full-text search of the corpus for "data center" since May 15, 2026 returns 101 documents; a hand-checked sample of the first 50 spans at least 24 distinct municipalities across 13 states, including first appearances in this analysis from Washington, Wyoming, Georgia, Oklahoma, and Pennsylvania, beyond the Maine/New Hampshire concentration the May figures showed. That is a different measurement lens from the 80/47/24 pipeline-tag figures above, not a direct continuation of them, but it points the same direction: more places are writing this into their agendas each month, not fewer.

That pattern is exactly the failure mode a platform decision-maker at a hedge-fund-backed renewables developer described from the demand side: *"By the time that load application happens, it's too late. They've already been working with the developers. I want to see something before that."* The moratorium fight in Scarborough, the tiered ordinance in Brunswick, the unanimous vote in Utica: each was visible in a committee minute or a workshop packet weeks or months before a load application, a permit denial, or a lawsuit becomes the version of the story that reaches trade press.

The decision is coming. We see it first.
...
All quoted document text is sourced. Every link goes to the original municipal, state-government, or news document. Original analysis data current to May 14, 2026; the "August 2026 Update" section above is current to August 26, 2026 and uses a full-text corpus search rather than the production pipeline's data-center-zoning tag (see the note at the top of that section). The two are complementary, not additive.
