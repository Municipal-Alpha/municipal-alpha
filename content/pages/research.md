...
Slug: data-stories
Sortorder: 2
Summary: Cross-municipal patterns from live pipeline data. Each story is built entirely from public records across 4,400+ municipalities.
...
<div class="ds-hero">
<h2>Patterns only visible at 4,400+ municipalities</h2>
...
<div class="ds-card-stat"><strong>4,400+</strong> municipalities &middot; <strong>100+</strong> resolved tickers</div>
</div>
</a>
...
<div class="ds-dataset-meta"><strong>4,400+</strong> municipalities &middot; daily updates</div>
...
<p>The pipeline monitors 4,400+ municipalities in real time. If there's a trend, policy wave, or spending pattern you want us to dig into, we'll build the data story.</p>
